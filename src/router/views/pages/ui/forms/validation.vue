      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <p class="sub-header">Vuelidate is a validation library in Vue. It helps you provide
            ...
            <form @submit.prevent="handleSubmit">
              <div class="form-group">
                ...
                <input id="username" v-model="form.name" name="username" class="form-control"
                  :class="{ 'is-invalid': submitted && $v.form.name.$error }" type="text" placeholder="Enter user name" />
              ...
              <div class="form-group">
                ...
                <input v-model="form.email" type="email" name="email" class="form-control"
                  :class="{ 'is-invalid': submitted && $v.form.email.$error }" placeholder="Enter email" />
              ...
              <div class="form-group">
                ...
                <input v-model="form.password" type="password" name="password" class="form-control" :class="{
              ...
              <div class="form-group">
                ...
                <input id="passWord2" v-model="form.confirmPassword" type="password" name="confirmPassword"
      ...
      <div class="col-lg-6">
        <div class="card">
          <div class="card-body">
            ...
            <p class="text-muted font-14 m-b-20">Vuelidate is a validation library in Vue. It helps you provide
              your users with feedback on their form submission before sending
              it to your server.</p>
            ...
            <form @submit.prevent="horizontalForm">
              <div class="form-group row">
                ...
                <div class="col-7">
                  <input v-model="horizontal.email" type="email" name="email" class="form-control" :class="{
              ...
              <div class="form-group row">
                ...
                <div class="col-7">
                  <input v-model="horizontal.password" type="password" name="password" class="form-control" :class="{
              ...
              <div class="form-group row">
                ...
                <div class="col-7">
                  <input v-model="horizontal.confirmPassword" type="password" name="confirmPassword" class="form-control"
                    :class="{
                      'is-invalid':
              ...
              <div class="form-group row">
                ...
                <div class="col-7">
                  <input id="website" v-model="horizontal.website" type="text" name="website" class="form-control" :class="{
          ...
          <div class="card-box">
            ...
            <form action="#" @submit.prevent="typeForm">
              <div class="form-group">
                ...
                <input v-model="typeform.name" type="text" class="form-control" placeholder="Type something" name="name"
                  :class="{
              ...
              <div class="form-group">
                ...
                <div class="mt-2">
                  <input v-model="typeform.confirmPassword" type="password" name="confirmPassword" class="form-control"
                    :class="{
                      'is-invalid':
          ...
          <div class="card-body">
            ...
            <form action="#" @submit.prevent="rangeform">
              <div class="form-group">
                ...
                <div>
                  <input v-model="range.minlen" type="text" name="minlen" class="form-control"
                    :class="{ 'is-invalid': submit && $v.range.minlen.$error }" placeholder="Min 6 chars." />
              ...
              <div class="form-group">
                ...
                <div>
                  <input v-model="range.between" type="text" class="form-control" name="between"
              ...
              <div class="form-group">
                ...
                <div>
                  <input v-model="range.minval" type="text" name="minval" class="form-control"
                    :class="{ 'is-invalid': submit && $v.range.minval.$error }" placeholder="Min value is 6" />
              ...
              <div class="form-group">
                ...
                <div>
                  <input v-model="range.maxval" type="text" class="form-control" name="maxval"
                    :class="{ 'is-invalid': submit && $v.range.maxval.$error }" placeholder="Max value is 6" />
              ...
              <div class="form-group">
                ...
                <div>
                  <input v-model="range.expr" type="text" class="form-control" name="expr"
                    :class="{ 'is-invalid': submit && $v.range.expr.$error }" placeholder="Hex. Color" />
