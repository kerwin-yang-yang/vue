...
<template>
	<div class="card">
		<div class="card-body pt-2 pb-3">
			<router-link to="/" class="btn btn-primary btn-sm mt-2 float-right" href="javascript: void(0);">View
				All</router-link>
			<h6 class="header-title mb-4">Activities</h6>

			<div class="media">
				<img src="@assets/images/users/avatar-7.jpg" class="mr-3 avatar rounded-circle" alt="officeShield" />
				<div class="media-body">
					<h6 class="mt-0 mb-0 font-size-15 font-weight-normal">
						<a href class="font-weight-bold">officeShield</a> has attached
			...
			<div class="media mt-3">
				...
				<div class="media-body">
					<h6 class="mt-0 mb-0 font-size-15 font-weight-normal">
						...
						comment from
						<span class="font-weight-bold text-primary">officeShield</span> on project
						<span class="font-weight-bold text-primary">Admin</span>
					</h6>
